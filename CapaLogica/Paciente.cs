...
namespace CapaLogica
{
    public class Paciente : Persona
    {
        ...
        public List<Medicamento> MedicamentosYaAgregados(List<Medicamento> TodosMedicamentos)
        {List<Medicamento> Recomendados = new List<Medicamento>();
            Diagnostico oDiagnostico = ultimodiagnostico();
            Recomendados = oDiagnostico.QuitarMedicamentosAgregados(TodosMedicamentos);
            return Recomendados;
        }      
        ...
        public Diagnostico ultimodiagnostico()
        {
            ...
            if (this.ListaDiagnosticos.Count != 0)
            {
        ...
        {
            Diagnostico unDiagnostico = new Diagnostico();
            unDiagnostico = this.ListaDiagnosticos.Last();
